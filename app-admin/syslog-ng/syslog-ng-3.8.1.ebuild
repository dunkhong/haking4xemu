...
src_compile() {
	...
	sed -i "s_^JNI_CFLAGS .*_JNI_CFLAGS = -I/usr/lib/jvm/$(java-config -f)/include -I" Makefile
	sed -i "s_^JNI_LIBS .*_JNI_LIBS = -L/usr/lib/jvm/$(java-config -f)/lib -ljvm" Makefile
